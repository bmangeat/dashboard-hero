        ...
        h('section', {class: 'comp-weather'}, [
            ...
            h('div', {class: 'comp-body'}, [
                ...
                h('div', {class: 'info-weather'}, [
                    h('div', {class: 'message'}, [
                        h('p', {}, ['La vie est belle à ' + props.work.base.replace(/,.*/, '') + " : aucun vilain à l'horizon !"])
                    ]),
                ...
                h('div', {class: 'info-weather'}, [
                    h('div', {class: 'message'}, [
                        h('p', {}, ['Les oiseaux chantent à ' + props.hero.work.base.replace(/,.*/, '') + ' et les vilains se cachent !'])
                    ]),
                    h('div', {class: 'illustration'}, [
                        h('svg', {version:"1.1", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 550 290", style:"enable-background:new 0 0 550 290;"}, [
                            h('g', {id:"Background"}, [
                ...
                h('div', {class: 'info-weather'}, [
                    h('div', {class: 'message'}, [
                        h('p', {}, ['Les vilains se font discrets à ' + props.hero.work.base.replace(/,.*/, '') + '...'])
                    ]),
                    h('div', {class: 'illustration'}, [
                        h('svg', {version:"1.1", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 550 290", style:"enable-background:new 0 0 550 290;"}, [
                            h('g', {id:"Background"}, [
                ...
                h('div', {class: 'info-weather'}, [
                    h('div', {class: 'message'}, [
                        h('p', {}, ['Les vilains sont de sortie dans les rues de ' + props.hero.work.base.replace(/,.*/, '') + ' !'])
                    ]),
                    h('div', {class: 'illustration'}, [
                        h('svg', {version:"1.1", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 550 290", style:"enable-background:new 0 0 550 290;"}, [
                            h('g', {id:"Background"}, [
                ...
                h('div', {class: 'info-weather'}, [
                    h('div', {class: 'message'}, [
                        h('p', {}, ['Invasion de super-vilains à ' + props.hero.work.base.replace(/,.*/, '') + ' !'])
                    ]),
                    h('div', {class: 'illustration'}, [
                        h('svg', {version:"1.1", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 550 290", style:"enable-background:new 0 0 550 290;"}, [
                            h('g', {id:"Background"}, [

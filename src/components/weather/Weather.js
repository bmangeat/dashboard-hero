        ...
        <div class="comp-body">
            <div class="illustration">
                ...
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 550 290" preserveAspectRatio="xMinYMin meet">
                    ...
                    />
                    <g id="Background">
                        <rect class="st0" width="550" height="290" fill="url(#SVGID_1_)"/>
                    </g>
                    <g id="City">
                        <path id="Plan3" class="st1" fill="url(#Plan3_1_)" d="M0,223.3h265h9.6H550v-94.4h-4.2v-17.4l-18-15.3v32.7h-13.1v14h-33.9v-25.7H455v19h-19.6v19.7
                        ...
                        <path id="Plan2" class="st2" fill="url(#Plan2_1_)" d="M0,271.8c95.6,0,191.3,0,286.9,0v1.7H550v-78.9h-19.3v14.6h-4V173h-19.3v36.3h-15V150h-46.8
                        ...
                        <path id="Plan1" class="st3" fill="url(#Plan1_1_)" d="M0,290c183.3,0,366.7,0,550,0v-16.5v-29.2h-11.1v-71.1l-19.3,8.6v75.8h-26.3v-11.1h-22.6v8h-25

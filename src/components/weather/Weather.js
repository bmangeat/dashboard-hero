...
const logo_lvl_0 = h('div', {class: 'col-md-1'}, [
    h('svg', {version:"1.1", id:"alert-logo", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 24.5 24.5", style:"enable-background:new 0 0 24.5 24.5;", width:"24.5", height:"24.5"}, [
...
const logo_lvl_1 = h('div', {class: 'col-md-1'}, [
    h('svg', {version:"1.1", id:"alert-logo", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 24.5 24.5", style:"enable-background:new 0 0 24.5 24.5;", width:"24.5", height:"24.5"}, [
...
const logo_lvl_2 = h('div', {class: 'col-md-1'}, [
    h('svg', {version:"1.1", id:"alert-logo", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 24.5 24.5", style:"enable-background:new 0 0 24.5 24.5;", width:"24.5", height:"24.5"}, [
...
const logo_lvl_3 = h('div', {class: 'col-md-1'}, [
    h('svg', {version:"1.1", id:"alert-logo", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 24.5 24.5", style:"enable-background:new 0 0 24.5 24.5;", width:"24.5", height:"24.5"}, [
...
const logo_lvl_4 = h('div', {class: 'col-md-1'}, [
    h('svg', {version:"1.1", id:"alert-logo", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 24.5 24.5", style:"enable-background:new 0 0 24.5 24.5;", width:"24.5", height:"24.5"}, [
...
const logo_lvl_5 = h('div', {class: 'col-md-1'}, [
    h('svg', {version:"1.1", id:"alert-logo", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 24.5 24.5", style:"enable-background:new 0 0 24.5 24.5;", width:"24.5", height:"24.5"}, [
...
export default (props) =>
    props.weather === 'Clear' ?
        h('section', {}, [
            h('div', {class: 'component-title'}, ['Météo du crime']),
            h('div', {class: 'row'}, [
                h('div', {class: 'col-md-6'}, [
                    h('div', {class: 'box'}, [
                        h('div', {class: 'row'}, [
                            h('div', {class: 'col-md-6'}, ['La vie est belle à ' + props.hero.work.base + ' !'])
                        ]),
                        h('div', {class: 'row'}, [
                            h('div', {class: 'col-md-6'}, [
        ...
        h('section', {}, [
            ...
            h('div', {class: 'row'}, [
                h('div', {class: 'col-md-6'}, [
                    h('div', {class: 'box'}, [
                        h('div', {class: 'row'}, [
                            h('div', {class: 'col-md-6'}, ['Les oiseaux chantent à ' + props.hero.work.base + ' !'])
                        ]),
                        h('div', {class: 'row'}, [
                            h('div', {class: 'col-md-6'}, [
                                h('svg', {version:"1.1", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 550 290", style:"enable-background:new 0 0 550 290;"}, [
        ...
        h('section', {}, [
            ...
            h('div', {class: 'row'}, [
                h('div', {class: 'col-md-6'}, [
                    h('div', {class: 'box'}, [
                        h('div', {class: 'row'}, [
                            h('div', {class: 'col-md-6'}, ['Ne vous promenez pas seul dans ' + props.hero.work.base + '...'])
                        ]),
                        h('div', {class: 'row'}, [
                            h('div', {class: 'col-md-6'}, [
                                h('svg', {version:"1.1", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 550 290", style:"enable-background:new 0 0 550 290;"}, [
        ...
        h('section', {}, [
            ...
            h('div', {class: 'row'}, [
                h('div', {class: 'col-md-6'}, [
                    h('div', {class: 'box'}, [
                        h('div', {class: 'row'}, [
                            h('div', {class: 'col-md-6'}, ['Des super-vilains sont de sortie dans ' + props.hero.work.base + ' !'])
                        ]),
                        h('div', {class: 'row'}, [
                            h('div', {class: 'col-md-6'}, [
                                h('svg', {version:"1.1", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 550 290", style:"enable-background:new 0 0 550 290;"}, [
        ...
        h('section', {}, [
            ...
            h('div', {class: 'row'}, [
                h('div', {class: 'col-md-6'}, [
                    h('div', {class: 'box'}, [
                        h('div', {class: 'row'}, [
                            h('div', {class: 'col-md-6'}, ['Invasion de super-vilains à ' + props.hero.work.base + ' !'])
                        ]),
                        h('div', {class: 'row'}, [
                            h('div', {class: 'col-md-6'}, [
                                h('svg', {version:"1.1", xmlns:"http://www.w3.org/2000/svg", x:"0px", y:"0px", viewBox:"0 0 550 290", style:"enable-background:new 0 0 550 290;"}, [
